...
describe('NaryFraction', () => {
  ...
  it('simplifies fractions', () => {
    ...
    expect(f(3, [1], [0, 2, 1])).toEqual([[], [1, 0, 2]])
    expect(f(4, [], [3, 3, 3])).toEqual([[], [3]])

    expect(f(4, [3, 1, 1, 0, 2, 1, 0, 2, 1], [0, 2, 1]))
      .toEqual([[3, 1], [1, 0, 2]])
    expect(f(4, [3, 1, 1, 0, 2, 1, 0, 2, 1], [0, 2, 1, 0, 2, 1]))
      .toEqual([[3, 1], [1, 0, 2]])
  })
  ...
  it('supports parsing string input', () => {
    ...
    expect(parseDozenal('11,9,2').equals(dozenal([11, 9, 2], [])))
    expect(parseDozenal('11,9,2_').equals(dozenal([11, 9, 2], [])))
...
describe('reduceCircularSequence()', () => {
  ...
  it('works', () => {
    expect(f(4, [3, 3, 3])).toEqual([3])
    expect(f(4, [1, 2, 3])).toEqual([1, 2, 3])
    expect(f(4, [1, 2, 3, 1, 2, 3])).toEqual([1, 2, 3])
    expect(f(2, [1, 0, 1])).toEqual([1, 0, 1])
  })
})
